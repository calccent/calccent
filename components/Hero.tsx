...
export default function Hero() {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative overflow-hidden min-h-[55vh] md:min-h-[65vh] flex items-center"
      style={{
        background: 'linear-gradient(135deg, #EEF2FF 0%, #E0E7FF 30%, #C7D2FE 60%, #A5B4FC 100%)',
      }}
    >
      {/* Animated Background Glows - Lighter */}
      <div 
        className="hero-glow top-1/4 left-1/4"
        style={{ 
      ...
      />
      <div 
        className="hero-glow-accent bottom-1/4 right-1/4"
        style={{ 
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-6 md:mt-8 justify-center lg:justify-start">
              ...
              <Link 
                href="/about"
                className="inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 bg-white/70 backdrop-blur-sm text-gray-700 rounded-2xl font-semibold border border-gray-200 hover:bg-white/90 hover:shadow-md transition-all text-sm md:text-base"
              >
                Learn More
              </Link>
            </div>
